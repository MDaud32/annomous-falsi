          ...
          <blockquote className="mt-6 md:flex md:flex-grow md:flex-col">
            <div className="relative text-lg font-medium text-white md:flex-grow">
              ...
              <p className="relative">
                I love using this anonymous messaging bot in Slack! It's so easy
                to use and allows me to give feedback to coworkers without the
                fear of being judged. It's really helped improve communication
                and collaboration on our team!
              </p>
            </div>
        ...
        <div className="border-t-2 border-indigo-900 py-12 px-6 md:border-t-0 md:border-l md:py-16 md:pr-0 md:pl-10 lg:pl-16">
          ...
          <blockquote className="mt-6 md:flex md:flex-grow md:flex-col">
            <div className="relative text-lg font-medium text-white md:flex-grow">
              ...
              <p className="relative">
                As a manager, I've found this anonymous messaging bot to be
                incredibly useful for gathering honest feedback from my team.
                It's helped me identify areas where we need to improve and has
                even led to some great new ideas and innovations!
              </p>
            </div>
            <footer className="mt-8">
              <div className="flex items-start">
